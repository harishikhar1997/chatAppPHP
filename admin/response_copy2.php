...
// 				"action"=>"<a href='edit.php?id='.base64_encode(convert_uuencode(".$row["user_id"]."''))>Edit</a> | <a class='delete' id='del' href='delete.php?id='".$row["user_id"]."''>Delete</a>"
// 			);
// }
