...
if ($result->num_rows > 0){
	...
	//important part is <li> tag where data-chat-id variable is used to store chat_id
			echo "<div class='card-body contacts_body'>
							<ui class='contacts'>
								<li data-chat-id='".$chat_id."' class='chat-li' data-user='".$username."' data-status='".$currStatus."' sender='".$sender."' reciever='".$reciever."' part1='".$part1."' part2='".$part2."' parti='".$parti."' m_id='".$m_id."'>
...
///////////////////////////////////////////////////////////////////////////////////////
	//Script for new users to start chat with..
