...
if ($result->num_rows > 0){
	 							...
	 							<div class='card mb-sm-3 mb-md-0 contacts_card'>
	 								...
	 								<div class='card-header'>
										...
										while($row5 = $res5->fetch_assoc()){
											...
											if($row5['chatStatus']==1){
												echo "<ul><button style='background:none;border:none;'><a data-nuser='".$row5['username']."' data-nid='".$row5['user_id']."' data-ncstat='".$row5['chatStatus']."' class='new-users'>". $row5['username']. $row['chatStatus'] ."</a></button></ul>";
												// $sql7="UPDATE users SET users.chatStatus=1";
												// $conn->query($sql7);
											}
											else{
	...
	//important part is <li> tag where data-chat-id variable is used to store chat_id
			echo "<div class='card-body contacts_body'>
							<ui class='contacts'>
								<li data-chat-id='".$chat_id."' class='chat-li' data-user='".$username."' data-status='".$currStatus."' sender='".$sender."' reciever='".$reciever."' m_id='".$m_id."' part1='".$part1."' part2='".$part2."' parti='".$parti."'>
