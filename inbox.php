...
$sql="SELECT chat.chat_id,chat.part1,chat.part2,chat.lastmsg_id,
			...
			WHERE username LIKE '%".$keyword."%' AND (part1='".$currUser."' OR part2='".$currUser."') ORDER BY chat.lastmsg_id DESC";
...
if ($result->num_rows>=0){
	...
	//important part is <li> tag where data-chat-id variable is used to store chat_id
			...
			$inboxThread.= "<li data-chat-id='".$chat_id."' data-image='".$image."' class='chat-li' data-user='".$username."' data-status='".$currStatus."' sender='".$sender."' reciever='".$reciever."' m_id='".$m_id."' part1='".$part1."' part2='".$part2."' parti='".$parti."' last_seen='".$last_seen."'>
